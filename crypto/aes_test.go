...
func Test_DES_CBC(t *testing.T) {
	...
	cipher := crypto.DES([]byte("Z'{ru/^e")).CBC()
...
func Test_DES_ECB(t *testing.T) {
	...
	cipher := crypto.DES([]byte("Z'{ru/^e")).ECB()
...
func Test_DES_CFB(t *testing.T) {
	...
	cipher := crypto.DES([]byte("Z'{ru/^e")).CFB()
...
func Test_DES_OFB(t *testing.T) {
	...
	cipher := crypto.DES([]byte("Z'{ru/^e")).OFB()
...
func Test_DES_CTR(t *testing.T) {
	...
	cipher := crypto.DES([]byte("Z'{ru/^e")).CTR()
